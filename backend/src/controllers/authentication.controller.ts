...
export class AuthenticationController {
    ...
    private readonly GET_TOKEN_URL_BITCUCKET = "https://bitbucket.org/site/oauth2/access_token";
    ...
    public getProviderToken(@Req() req, @Res() response) {
        ...
        this.httpSrv.post(this.GET_TOKEN_URL_BITCUCKET, querystring.stringify(accessTokenOptions), accessTokenConfig).pipe(
            map(res => {
                let userToken = res.data.access_token;
                this.log.d("Response: ", res.data);
