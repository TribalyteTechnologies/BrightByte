...
export class AppConfig {
    ...
    public static readonly EXECUTION_ABORTED = "Returned error: execution aborted (timeout = 5s)";
    public static readonly ERROR_IDENTIFIERS = [
        AppConfig.NOT_CONVERTIBLE_STRING_ERROR_IDENTIFIER, AppConfig.VALUES_ARENT_VALID_ERROR_IDENTIFIER, AppConfig.EXECUTION_ABORTED];
